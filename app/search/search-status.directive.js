SearchCurrentStatusModalController.$inject = ['$uibModalInstance', 'modal', 'reportservice'];

function SearchCurrentStatusModalController($uibModalInstance, modal, reportservice) {
    var ctrlSts = this;
    ctrlSts.modal = modal;
...
SearchBhuCurrentStatusModalDirective.$inject = ['$uibModal', 'reportservice'];

function SearchBhuCurrentStatusModalDirective($uibModal, reportservice) {
    return {
        restrict: 'A',
               ...
               if(scope.item.bhuId){
                reportservice.getReportCurrentStatusDetails(scope.item.bhuId, scope.item.rtsSpoc).then(function(resp){
                       ...
                       $uibModal.open({
                            ...
                            controller: SearchCurrentStatusModalController,
...
module.exports = SearchBhuCurrentStatusModalDirective;