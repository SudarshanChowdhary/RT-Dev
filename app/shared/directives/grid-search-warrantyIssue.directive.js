...
function searchWarrantyIssueLinkRenderer(){
    return {
        restrict: 'EA',
        template: ['<div ng-bind-html="displayWarrantyissueItemName(item.warrantyissue)" searchwarrantyissue-link>',
            '</div>'
        ].join(''),
...
module.exports = searchWarrantyIssueLinkRenderer;